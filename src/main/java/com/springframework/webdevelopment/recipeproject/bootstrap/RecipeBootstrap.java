package com.springframework.webdevelopment.recipeproject.bootstrap;

import com.springframework.webdevelopment.recipeproject.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        //get Categories:
        Optional<Category> amercianCategoryOptional = categoryRepository.findByDescription("American");
        if(!amercianCategoryOptional.isPresent()){
        ...
        //get optional;
        Category americanCategory = amercianCategoryOptional.get();
        ...
        guacRecipe.setDifficulty(Difficult.EASY);
        ...
        tacosRecipe.setDifficulty(Difficult.MODERATE);
        ...
        tacosRecipe.setUrl("http://www.simplyrecipes.com/recipes/perfect_guacamole/");
